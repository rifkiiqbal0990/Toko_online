<div class="quixnav">
    <div class="quixnav-scroll">
        <ul class="metismenu" id="menu">
            <li class="nav-label first">Data Toko</li>
            ...
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        class="icon icon-chart-bar-33"></i><span class="nav-text">Produk</span></a>
                <ul aria-expanded="false">
                    <li><a href="/stok">Stok Barang</a></li>
                    <li><a href="/kategori">Daftar Kategori</a></li>
                    <li><a href="/tambah">Tambah Stok Barang</a></li>
                    <li><a href="/tambahKategori">Tambah Kategori Produk</a></li>
                </ul>
            </li>
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
            ...
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                ...
                <ul aria-expanded="false">
                    <li><a href="/">Halaman Belanja</a></li>
                </ul>
    </div>
